...
##Plot the tradeoﬀ curve of values,  Y axis for weighted distance and X axis for p.
```{r}
...
#for map when use the sites which does not involve using all ﬁve of these sites: 18, 49, 121, 159, 230
```{r}
...
```
The best sites when the populaion density is identified as weight.
